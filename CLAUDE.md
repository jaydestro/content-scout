...
| **Tools** | "scout originality", "originality check", "is this AI-generated", "review a link for originality", "check if copied from docs" | `.github/prompts/scout-originality.prompt.md` | Review how AI-generated a URL's content reads + check for un-attributed copying from official docs. Also one-click in the web UI under Tools → Originality. |
